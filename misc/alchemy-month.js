...
function generateKeywords(){
  ...
  extractKeywordsForDate(function(err, text, results){
...
function extractKeywordsForDate(cb){
  ...
  connection.query(query, [new Date(2012, 9, 1)], function(err, sections, fields){
    var tokenized, text;
