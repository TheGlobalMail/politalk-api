...
exports.addHeading = function(attrs, cb){
  var values = [attrs.id, exports.formatDate(attrs.date), attrs.html];
...
exports.addSpeech = function addSpeech(attrs, cb){
  ...
  var values = [attrs.id, exports.formatDate(attrs.date), attrs.html, attrs.headingId, attrs.subHeadingId, 
  ...
  var upsertAndExtractKeywords = function(cb){
    db.upsert(insert, update, values, function(err){
      ...
      exports.extractKeywords(attrs.id, attrs.html, exports.formatDate(attrs.date), cb);
    });
  };
